...
Namespace E232.Win
   Partial Public Class E232WindowsFormsApplication
      ...
      Private Sub HowToSetMaskForCustomWinPropertyEdtiorWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
